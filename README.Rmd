...
- `grch37_to_BED.R` and `grch37_to_bed.sh` - extract genomic coordinates of gene families into separate subfolders
- `grch37_to_KEGG.R` - extract genomic coordinates of genes in KEGG pathways
